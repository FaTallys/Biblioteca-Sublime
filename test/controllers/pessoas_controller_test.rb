...
class PessoasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pessoa" do
    assert_difference("Pessoa.count") do
      post pessoas_url, params: { pessoa: { idade: @pessoa.idade, nome: @pessoa.nome } }, as: :json
    end
  ...
  test "should update pessoa" do
    patch pessoa_url(@pessoa), params: { pessoa: { idade: @pessoa.idade, nome: @pessoa.nome } }, as: :json
    assert_response :success
  end
